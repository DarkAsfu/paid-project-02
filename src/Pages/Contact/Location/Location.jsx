const Location = () => {
    return (
        <div className="py-32 w-10/12 mx-auto">
            <h1 className="text-3xl md:text-5xl text-center font-bold text-[#0A0541]">Our Office</h1>
            <div className='grid md:grid-cols-3 gap-12 mt-12'>
                ...
                <div className='border text-center p-12 leading-9 hover:border-b-blue-500 transition'>
                    ...
                    <p><span className='font-bold'>Phone:</span> +8801799290914</p>
                </div>
                <div className='border text-center p-12 leading-9 hover:border-b-blue-500 transition'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-blue-500 mx-auto">
                    ...
                    <p><span className='font-bold'>Email:</span> royalcpa2023@gmail.com</p></div>
            </div>
        </div>
    );
};
